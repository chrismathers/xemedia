    ...
    $.fn.agile_carousel = function (options) {
        ...
        return this.each(function () {
            ...
            var create_control_set = function (set, set_number) {
                ...
                if (set !== "") {
                    if (set_number) {
                        control_set_html += "<div class='control_set_" + set_number + " control_set'><div class='control_set_" + set_number + "_inner control_set_inner'><div id='closeButton' onclick=\"parent.closeIframe()\"></div>";
                    }
